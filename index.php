                                ...
                                <form action="#" method="POST">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            placeholder="Contraseña a encriptar" required="ON">
                                        </div>
                                    </div>
                                    <div>
                                        <button class="btn btn-warning" name="encript">Encriptar</button>
                                    </div>                                   
                                </form>
                    ...
                    <div class="login">
                        ...
                        <form action="./controllers/login.php" method="POST" class="border p-3 formlogin">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" name="passw" class="form-control" placeholder="Contraseña" require="ON">
                            </div>
                            <div style="text-align: center;">
                                <button class="btn btn-success" name="acclogin">Ingresar</button>
                            </div>
                        </form>
                        <div style="margin-top: 20px;">
                            <form action="./controllers/login.php" method="POST">
                                <button class="btn btn-success" name="olvide">Olvide mi Contraseña</button>
                            </form>
                        </div>
                    </div>
                </div>
